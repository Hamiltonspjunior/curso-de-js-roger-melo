...
console.log(convertToString(25))
...
console.log(stringLength('Hamilton'))
...
const getIndexOf = (character, string = '') => string.indexOf(character)

console.log(getIndexOf('i', 'hamilton'))
...
console.log(isItemIncluded(3, ['oi', 3, true]))
...
const showMyName = () => console.log('Hamilton')
...
console.log(getLikesMessage(['Rafael', 'Lucas', 'Tales', 'João', 'Carlos']))